            ...
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className=" flex flex-col w-full">
                    <div className=" flex items-center gap-x-2">
                        ...
                        <span className=" text-xs  text-zinc-50 dark:text-zinc-400">
                            {timestamp}
                        </span>
                    </div>
                    {isImage && (
                        <a
                            ...
                            className="mt-1 relative aspect-square rounded-md mr-2 overflow-hidden border flex items-center bg-secondary h-48 w-48"
                        >
                            <Image
                                fill
                                src={fileUrl}
